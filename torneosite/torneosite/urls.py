...
urlpatterns += patterns('',
    ...
    url(r'^sub9/groups$', us, name='group_view1_all'),
    url(r'^sub9/group/(?P<pk>\d+)/$', us, name='group_view_sub9'),
    url(r'^sub9/eliminatoria/', us, name='eliminatoria_view_sub9'),
    url(r'^sub12/groups$', us, name='group_view2_all'),
    url(r'^sub12/group/(?P<pk>\d+)/$', us, name='group_view_sub12'),
    url(r'^sub12/eliminatoria/', us, name='eliminatoria_view_sub12'),
    url(r'^complete/$', index_all, name='index_all'),
    url(r'^deactivateusers/$', deactivateusers, name='deactivateusers'),
    url(r'^us/$', us, name='us'),
...
urlpatterns += patterns('',
    ...
    url(r'^match/pistas/(?P<pk>\d+)$', view_pista_match, name='view_pista_match'),
